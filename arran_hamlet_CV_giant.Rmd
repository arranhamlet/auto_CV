...
tribble(
  ...
  "PhD titled 'Yellow fever in South America: The role of environment and host on transmission dynamics'", "Imperial College London", "London, United Kingdom", "Jan 2017-Jan 2020", "Awarded 3 Medical Research Council (MRC) Exceptional Training Opportunity awards (total £4,589) and a MRC pump priming award (£23,000) to present results and design and run workshops in Brazil and Colombia for Ministries of Health and Universities.",
...
"Visiting Researcher", "Imperial College London", "London, United Kingdom", "Jun 2022-", "Provide direction and feedback for various projects, review manuscripts and plan strategic research goals.",
...
"Postdoctoral Researcher (Malaria)", "Imperial College London", "London, United Kingdom", "Jan 2020-Jun 2022", "Assessed the impact of disruption caused by the SARS-CoV-2 pandemic on malaria control across Africa. Presentation given to the London Malaria Network and results published Nature Medicine as joint first author.",
