...
\item Epidemic Intelligence Service Officer based at the Washington State Department of Health with a focus on communicable disease surveillance, outbreak response, and policy.
\item Established the surveillance system for long COVID, evaluated the tuberculosis reporting system and responded to outbreaks within the state of Washington.
\end{cvitems}}
...
\item Designed the Advanced Statistics in R course.
\end{cvitems}}
...
\begin{cventries}
    ...
    \cventry{Impact of non-pharmaceutical interventions (NPIs) to reduce COVID-19 mortality and healthcare demand. Imperial College London, 2020}{NM Ferguson, D Laydon, G Nedjati-Gilani, N Imai, K Ainslie, M Baguelin, S Bhatia, A Boonyasiri, Z Cucunubá, G Cuomo-Dannenburg, A Dighe, I Dorigatti, H Fu, K Gaythorpe, W Green, *A Hamlet*, W Hinsley, L Okell, SV Elsland, H Thompson, R Verity, E Volz, H Wang, Y Wang, P Walker, C Walters, P Winskill, C Whittaker, C Donnelly, S Riley, A Ghani}{Publish in The International Arabic Journal of Antimicrobial Agents}{2020}{}\vspace{-4.0mm}
