...
Infectious disease epidemiologist with 10+ years of experience in integrated disease surveillance, outbreak response, public health policy and research project management. Extensive global expertise in zoonotic diseases, One Health, and statistical/mathematical modelling to inform strategic interventions. Proven leadership in managing multi-sectoral teams and aligning programs with global frameworks. Adept at developing sustainable, localized solutions for epidemic and pandemic-prone diseases.
...
* Data Analytics and modelling: Utilising statistical and mathematical models for outbreak response and health security policy to ensure data-driven results.
...
* Organised international collaborations with the US CDC, WHO, and Ministries of Health.
...
tribble(
  ...
  "Infectious Disease Surveillance Lead", "PATH", "London, United Kingdom", "Sep 25-now", "Infectious Disease Surveillance Lead for PATH's Epidemic Preparedness and Response Initiative, and project lead for the USG-funded Strengthening Infectious Disease Detection Systems (STRIDES) project, one of the largest infectious disease surveillance programmes currently operating globally.",
  
    "Infectious Disease Surveillance Lead", "PATH", "London, United Kingdom", "Sep 25-now", "PATH leads the technical area for infectious disease surveillance across STRIDES, spanning 36 countries. In this role I oversee the full technical implementation of that work: designing surveillance systems, providing technical oversight, engaging with government and partner stakeholders, and building the team delivering it on the ground.",

  "Research Fellow", "Imperial College London", "London, United Kingdom", "Mar 25-Aug 25", "Developing mathematical models for the Jameel Institute’s Realtime Intelligent Support for Emergencies initiative to assess vaccine-preventable outbreak risks in conflict settings.",
   "Research Fellow", "Imperial College London", "London, United Kingdom", "Mar 25-Aug 25", "Presented work in progress to researchers and policy makers at the WHO Global Hub for Pandemic and Epidemic Intelligence and Médecins Sans Frontière, and invited to present results at a symposium at the 2025 Annual American Society for Tropical Medicine and Hygiene conference. The project delivers critical data to help humanitarian organisations and policymakers prioritize aid in crisis settings.",
 ...
 "Postdoctoral Researcher (Malaria, COVID-19 and Yellow Fever)", "Imperial College London", "London, United Kingdom", "Jan 20-Jun 22", "Directed epidemiological modelling for malaria, COVID-19, and yellow fever to guide policy recommendations for Ministries of Health in Brazil, Nigeria, Ethiopia, and global organisations such as the WHO, CDC and USAID.",
  "Postdoctoral Researcher (Malaria, COVID-19 and Yellow Fever)", "Imperial College London", "London, United Kingdom", "Jan 20-Jun 22", "Designed and implemented statistical and mathematical models to predict yellow fever spillover and the potential impact of invasive malaria vectors, published work in high-impact journals like Nature Communications and BMC Medicine.",
 ...
 "Consultant and Course Designer", "AppliedEpi", "Remote", "Jan 22-Present", "Created and taught advanced training modules in data management and analytics for outbreak response, utilized by WHO, CDC, and Ministries of Health.",
  "Consultant and Course Designer", "AppliedEpi", "Remote", "Jan 22-Present", "Authored chapters on data analysis and epidemiology for field manuals used by public health practitioners.",
    ...
    "Epidemiologist (COVID-19 and Yellow Fever Response)", "World Health Organization", "Remote and Geneva, Switzerland", "Jan 15-Sep 15 and Jan 20-Apr 20", "Produced rapid epidemiological analysis and operational guidelines for outbreak response, with a focus on epidemiological drivers and transmission potential in Angola and the Democratic Republic of the Congo."
...
* Capacity Building: Awarded funding; designed, managed, and delivered virtual and in-person training for outbreak response and data analysis for policy in LMICs to hundreds of participants.
...
* Topics include zoonotic disease surveillance, modelling infectious disease dynamics, and health security.
