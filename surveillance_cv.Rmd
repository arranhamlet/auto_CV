...
tribble(
  ...
  "Research Fellow", "Imperial College London", "London, United Kingdom", "Mar 25-present", "Developing mathematical models for the Jameel Institute’s Realtime Intelligent Support for Emergencies initiative to assess vaccine-preventable outbreak risks in conflict settings.",
   "Research Fellow", "Imperial College London", "London, United Kingdom", "Mar 25-present", "Presented work in progress to researchers and policy makers at the WHO Global Hub for Pandemic and Epidemic Intelligence and Médecins Sans Frontière. The project delivers critical data to help humanitarian organisations and policymakers prioritize aid in crisis settings.",
