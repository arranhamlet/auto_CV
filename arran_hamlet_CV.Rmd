...
tribble(
  ...
  "Epidemic Intelligence Service Officer", "Centers for Disease Control and Prevention", "Seattle, United States of America", "July 2022-", "Epidemic Intelligence Service Officer based at the Washington State Department of Health with a focus on communicable disease surveillance, outbreak response, and policy.",
    "Epidemic Intelligence Service Officer", "Centers for Disease Control and Prevention", "Seattle, United States of America", "July 2022-", "Established the surveillance system for long COVID, evaluated the tuberculosis reporting system and responded to outbreaks within the state of Washington.",
...
tribble(
  ...
  "Course Instructor and Curriculum Designer", "AppliedEpi", "Online", "Jan 2022 - ", "Responsible for creating learning materials for self directed and taught courses designed to teach Epidemiologists how to code in R..",
    "Course Instructor and Curriculum Designer", "AppliedEpi", "Online", "Jan 2022 - ", "Lead and assisted on taught courses teaching applied epidemiology to various Health Departments (Wales, Kazakhstan, Cambodia, Canada).",
      "Course Instructor and Curriculum Designer", "AppliedEpi", "Online", "Jan 2022 - ", "Designed the Advanced Statistics in R course.",
