...
tribble(
 ...
 "Postdoctoral Researcher (Malaria)", "Imperial College London", "London, United Kingdom", "Jan 2020-", "Lead researcher on a piece of work assessing the potential impact of Anopheles stephensi establishment on malaria transmission in Ethiopia.",
...
tribble(
  ~ role, ~ company, ~ loc, ~ dates, ~ details,
  "Content creator/teaching assistant", "AppliedEpi", "Online", "Jan 2022 - ", "Responsible for creating learning materials for self directed and taught courses designed to teach Epidemiologists how to code in R",
...
pubs %>%
    dplyr::filter(first_author == F & preprint == F & journal != "Imperial College London") %>%
    dplyr::arrange(desc(year), desc(cites)) %>%
    detailed_entries(
        what = title,
        when = as.character(year),
